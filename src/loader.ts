import {IPluginLoader, ILogger, IConfig, ISensorManager, ISensor, ITriggerManager, IPresenceManager, IValuesManager, IClassTypeFactory} from '@homenet/core';
import {EventEmitter} from 'events';
import {connect} from './client';
import {NinjaBlockSensor} from './sensor';

export function create(annotate): { NinjaBlockPluginLoader: new(...args: any[]) => IPluginLoader } {
  @annotate.plugin()
  class NinjaBlockPluginLoader implements IPluginLoader {
